    ...
    const actionBodyTemplate = () => {
        return (
            <div className='d-flex justify-content-center align-items-center'>
                <Button icon="pi pi-eye" className="p-button-rounded p-button-info p-button-sm py-1 mx-2" aria-label="Voir"  label="Voir" />
                ...
                <Button icon="pi pi-times" className="p-button-rounded p-button-danger p-button-sm py-1 mx-2" aria-label="Supprimer" label="Supprimer" />
            </div>
        )
    }
