            ...
            <div className='d-flex justify-content-between align-items-center'>
                <div className="flex justify-content-between align-items-center">
                    <span className="p-input-icon-left">
                        ...
                        <InputText value={globalFilterValue} onChange={onGlobalFilterChange} placeholder="Rechercher une leçons" />
                    </span>
                </div>
                <div className=''>
                    <Button  
                        onClick={()=>navigate('/lecons/ajout_lecon',{replace:true})}
...
export default LeconsDataTable
